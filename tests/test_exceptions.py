...
class read_structExceptions(unittest.TestCase):
    ...
    def test_structureErrorZeroVolume(self):
        ...
        self.assertRaises(
            pdffit2.structureError,
            self.P.read_struct,
            self.datafile("badNiZeroVolume.stru"),
        )
...
class read_dataExceptions(unittest.TestCase):
    ...
    def test_IOError(self):
        ...
        self.assertRaises(
            IOError, self.P.read_data, "Nofile.dat", "X", 25.0, 0.5
        )
...
class pdfrangeExceptions(unittest.TestCase):
    ...
    def test_ValueError1(self):
        ...
        self.assertRaises(
            ValueError, self.P.pdfrange, self.iset, self.rmin, self.rmax
        )
    ...
    def test_ValueError2(self):
        ...
        self.assertRaises(
            ValueError, self.P.pdfrange, self.iset, self.rmax, self.rmin
        )
...
class save_pdfExceptions(unittest.TestCase):
    ...
    def test_IOError(self):
        ...
        self.P.calc()
        self.assertRaises(
            IOError, self.P.save_pdf, 1, "nodir183160/" + self.strufile
        )

    def test_unassignedError(self):
        """Raise pdffit2.unassignedError when structure is undefined."""
        self.assertRaises(
            pdffit2.unassignedError, self.P.save_pdf, 1, self.strufile
        )
...
class save_difExceptions(unittest.TestCase):
    ...
    def test_IOError(self):
        ...
        self.P.read_data(self.datafile("Ni.dat"), "X", 25.0, 0.5)
        self.assertRaises(
            IOError, self.P.save_dif, 1, "nodir183160/" + self.strufile
        )

    def test_unassignedError(self):
        """Raise pdffit2.unassignedError when structure is undefined."""
        self.assertRaises(
            pdffit2.unassignedError, self.P.save_dif, 1, self.strufile
        )
...
class save_resExceptions(unittest.TestCase):
    ...
    def test_IOError(self):
        ...
        self.P.refine_step()
        self.assertRaises(
            IOError, self.P.save_res, "nodir183160/" + self.resfile
        )

    def test_unassignedError(self):
        """Raise pdffit2.unassignedError when structure is undefined."""
        self.assertRaises(
            pdffit2.unassignedError, self.P.save_res, self.resfile
        )
...
class save_structExceptions(unittest.TestCase):
    ...
    def test_IOError(self):
        ...
        self.P.read_struct(self.datafile("Ni.stru"))
        self.assertRaises(
            IOError, self.P.save_struct, 1, "nodir183160/" + self.strufile
        )

    def test_unassignedError(self):
        """Raise pdffit2.unassignedError when structure is undefined."""
        self.assertRaises(
            pdffit2.unassignedError, self.P.save_struct, 1, self.strufile
        )
...
class constrainExceptions(unittest.TestCase):
    ...
    def test_unassignedError(self):
        ...
        self.assertRaises(
            pdffit2.unassignedError, self.P.constrain, self.P.x(1), self.par
        )
        return
    ...
    def test_constrainNonRefVar(self):
        ...
        self.P.read_data(self.datafile("Ni.dat"), "X", 25.0, 0.0)
        self.assertRaises(
            pdffit2.constraintError, self.P.constrain, "rcut", "@7"
        )
        self.assertRaises(
            pdffit2.constraintError, self.P.constrain, "rcut", 13
        )
        self.assertRaises(
            pdffit2.constraintError, self.P.constrain, "stepcut", "@17"
        )
        return
...
class setvarExceptions(unittest.TestCase):
    ...
    def test_unassignedError(self):
        """Raise pdffit2.unassignedError when variable is undefined."""
        self.assertRaises(
            pdffit2.unassignedError, self.P.setvar, self.P.lat(1), self.val
        )
...
class getvarExceptions(unittest.TestCase):
    ...
    def test_unassignedError(self):
        """Raise pdffit2.unassignedError when variable is undefined."""
        self.assertRaises(
            pdffit2.unassignedError, self.P.getvar, self.P.pscale()
        )
...
class selectAtomTypeExceptions(unittest.TestCase):
    ...
    def test_unassignedError2(self):
        ...
        self.assertRaises(
            pdffit2.unassignedError, self.P.selectAtomType, 2, "i", "Ca", True
        )
    ...
    def test_ijcharValueError(self):
        ...
        self.assertRaises(
            ValueError, self.P.selectAtomType, self.iset, "k", "Ni", True
        )
...
class selectAtomIndexExceptions(unittest.TestCase):
    ...
    def test_unassignedError2(self):
        ...
        # fail for phase 2
        self.assertRaises(
            pdffit2.unassignedError, self.P.selectAtomIndex, 2, "i", 1, True
        )
    ...
    def test_ValueError(self):
        ...
        self.P.read_data(self.datafile("Ni.dat"), "X", 25.0, 0.0)
        self.assertRaises(
            ValueError, self.P.selectAtomIndex, self.iset, "i", 6, True
        )
...
class selectAllExceptions(unittest.TestCase):
    ...
    def test_unassignedError1(self):
        """Raise pdffit2.unassignedError when set does not exist."""
        self.assertRaises(
            pdffit2.unassignedError, self.P.selectAll, self.iset, "i"
        )
...
class selectNoneExceptions(unittest.TestCase):
    ...
    def test_unassignedError1(self):
        """Raise pdffit2.unassignedError when set does not exist."""
        self.assertRaises(
            pdffit2.unassignedError, self.P.selectNone, self.iset, "i"
        )
...
class bangExceptions(unittest.TestCase):
    ...
    def test_unassignedError(self):
        """Raise pdffit2.unassignedError when phase does not exist."""
        self.assertRaises(
            pdffit2.unassignedError, self.P.bang, self.a1, self.a2, self.a3
        )
...
class blenExceptions(unittest.TestCase):
    ...
    def test_unassignedError(self):
        ...
        self.assertRaises(
            pdffit2.unassignedError, self.P.blen, self.a1, self.a2
        )
