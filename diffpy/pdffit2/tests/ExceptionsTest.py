...
class read_structExceptions(unittest.TestCase):
    ...
    def test_structureError(self):
        ...
        self.assertRaises(
            pdffit2.structureError, self.P.read_struct, datafile("badNi.stru")
        )
    ...
    def test_structureErrorZeroVolume(self):
        ...
        self.assertRaises(
            pdffit2.structureError, self.P.read_struct, datafile("badNiZeroVolume.stru")
        )
...
class read_dataExceptions(unittest.TestCase):
    ...
    def test_dataError(self):
        ...
        self.assertRaises(
            pdffit2.dataError, self.P.read_data, datafile("badNi.dat"), "X", 25.0, 0.5
        )
...
class selectAtomTypeExceptions(unittest.TestCase):
    ...
    def test_unassignedError1(self):
        ...
        self.assertRaises(
            pdffit2.unassignedError, self.P.selectAtomType, self.iset, "i", "Ni", True
        )
